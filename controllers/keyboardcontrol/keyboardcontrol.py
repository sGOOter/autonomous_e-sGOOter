...
# Global declaration of control variables
global bcyS
bcyS = maxS  # Initialize with max speed
...
def keyCtrl():
    ...
    # Apply the speed and steering changes to the motors
    whemotor.setVelocity(bcyS)
    hndmotor.setPosition(hndB)
    print(f"Speed set to: {bcyS}, Handlebar angle set to: {hndB}")  # Debug output
